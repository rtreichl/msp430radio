...
void tpa2016d2_equalizer_mode(uint8_t Mode, int8_t Gain)
{
	...
	case 0:
		// POP
		i2c_write_var(I2C_TPA2016D2_ADR, STOP, 7, 0x02, 0x03, 0x08, 0x0A, (Gain & 0x3F), 0x4C, 0xC2);
		break;
	case 1:
		// CLASSIC
		i2c_write_var(I2C_TPA2016D2_ADR, STOP, 7, 0x02, 0x02, 0x07, 0x0A, (Gain & 0x3F), 0x4D, 0xC1);
		break;
	case 2:
		// JAZZ
		i2c_write_var(I2C_TPA2016D2_ADR, STOP, 7, 0x02, 0x06, 0x14, 0x00, (Gain & 0x3F), 0x4D, 0xC1);
		break;
	case 3:
		// RAP HIP HOP
		i2c_write_var(I2C_TPA2016D2_ADR, STOP, 7, 0x02, 0x01, 0x0A, 0x00, (Gain & 0x3F), 0x4C, 0xC2);
		break;
	case 4:
		// ROCK
		i2c_write_var(I2C_TPA2016D2_ADR, STOP, 7, 0x02, 0x03, 0x19, 0x00, (Gain & 0x3F), 0x4D, 0xC1);
		break;
	case 5:
		// NEWS VOICE
		i2c_write_var(I2C_TPA2016D2_ADR, STOP, 7, 0x02, 0x02, 0x0A, 0x00, (Gain & 0x3F), 0x4E, 0xC2);
		break;
	}
}
