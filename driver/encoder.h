...
#define ENCODER_1_PIN	P1IN	//Port Input from Encoder 1
#define ENCODER_1_DIR	P1DIR	//Direction from Encoder 1
#define ENCODER_1_IFG	P1IFG	//Interrupt Flag from Encoder 1
#define ENCODER_1_IES	P1IES	//Interrupt Edge Selector from Encoder 1
#define ENCODER_1_REN	P1REN	//Pullup/Pulldown from Encoder 1
#define ENCODER_1_OUT	P1OUT	//Port Output from Encoder 1
#define ENCODER_1_IE	P1IE	//Interrupt Enable from Encoder 1
#define ENCODER_1_A		BIT3	//PIN A from Encoder 1
#define ENCODER_1_B		BIT4	//PIN B from Encoder 1
#define ENCODER_1_T		BIT5	//PIN Button from Encoder 1
