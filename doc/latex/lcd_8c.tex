\hypertarget{lcd_8c}{}\section{driver/src/lcd.c-\/\+Dateireferenz}
\label{lcd_8c}\index{driver/src/lcd.\+c@{driver/src/lcd.\+c}}
{\ttfamily \#include $<$driver/lcd.\+h$>$}\\*
Include-\/\+AbhÃ¤ngigkeitsdiagramm fÃ¼r lcd.\+c\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
...
\begin{center}
\leavevmode
\includegraphics[width=264pt]{lcd_8c_ab99e48ab8689dcb1205c4c7c97bd9956_icgraph}
\end{center}
\end{figure}
...
331     pos = x + y * 16;
332 
333     \textcolor{comment}{/*if(num == 0) \{}
334 \textcolor{comment}{        num = 48;}
335 \textcolor{comment}{    \}*/}
336 
337     \textcolor{comment}{/* if string is empty determinat string on given position */}
338     \textcolor{keywordflow}{if}(str == 0) \{
339         lcd\_view[48] = 0;
340     \}
341     \textcolor{keywordflow}{else} \{
342         \textcolor{comment}{/* copy string on given position */}
343         \textcolor{keywordflow}{while}(*str != 0 && pos < 48 ) \{\textcolor{comment}{//&& num > 0) \{}
344             lcd\_view[pos++] = *(str++);
345             \textcolor{comment}{//num--;}
346         \}
347     \}
348 
...
\begin{center}
\leavevmode
\includegraphics[width=347pt]{lcd_8c_a6b9abf6cd27026b67144523ffbef4916_icgraph}
\end{center}
\end{figure}
...
203 
204     \textcolor{comment}{// Bitmuster übertragen}
...
16     \hyperlink{settings_2radio__pin__mapping_8h_a131b17b16bb25a95f17f81423722dcb1}{PCA\_ON\_OFF\_SEL} &= (~\hyperlink{settings_2radio__pin__mapping_8h_a24dbe611147513e518aaa1b1034e19d9}{PCA\_ON\_OFF\_PIN});
17     \hyperlink{settings_2radio__pin__mapping_8h_aca9911d61d5202bad563d5f748782548}{PCA\_ON\_OFF\_DIR} |= \hyperlink{settings_2radio__pin__mapping_8h_a24dbe611147513e518aaa1b1034e19d9}{PCA\_ON\_OFF\_PIN};
18     \hyperlink{settings_2radio__pin__mapping_8h_abd6e55737a7d5e65b8582d647b103f8e}{PCA\_ON\_OFF\_OUT} |= \hyperlink{settings_2radio__pin__mapping_8h_a24dbe611147513e518aaa1b1034e19d9}{PCA\_ON\_OFF\_PIN};
19 
20 
...
\begin{center}
\leavevmode
\includegraphics[width=201pt]{lcd_8c_a312eed1baec275e185dc00b760de1356_icgraph}
\end{center}
\end{figure}
...
111                 chr = 0x94; \textcolor{comment}{//ö     break;
            case 0xFC:
            case 0x99:
                chr = 0x81; //ü
		     break;
...
115                 chr = 0x81; \textcolor{comment}{//ü     break;
            case 0xE4:
            case 0x91:
                chr = 0x84; //ä
	         break;
...
119                 chr = 0x84; \textcolor{comment}{//ä         break;
            case 0xDC:
            case 0xD9:
                chr = 0x9A; //Ü
             break;
...
123                 chr = 0x9A; \textcolor{comment}{//Ü             break;
            case 0xD6:
            case 0xD7:
                chr = 0x99; //Ö
             break;
...
127                 chr = 0x99; \textcolor{comment}{//Ö             break;
            case 0xC4:
            case 0xD1:
                chr = 0x8E; //Ä
             break;
...
131                 chr = 0x8E; \textcolor{comment}{//Ä             break;
        \}
