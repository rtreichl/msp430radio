...
= \{
        ...
        0,
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 0,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 0,
        1,
\}
\end{DoxyCode}
...
= \{
        ...
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 9,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 9,
        10,
\}
\end{DoxyCode}
...
= \{
        ...
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 10,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 10,
        11,
\}
\end{DoxyCode}
...
= \{
        ...
        &\hyperlink{station__list__struct_8c_acf5c64f9cad3cdf54491cac09a0909bd}{station\_11},
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 11,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 11,
        12,
\}
\end{DoxyCode}
...
= \{
        ...
        &\hyperlink{station__list__struct_8c_a92439b366ddf622544fd58932a0dd808}{station\_12},
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 12,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 12,
        13,
\}
\end{DoxyCode}
...
= \{
        0,
        &\hyperlink{station__list__struct_8c_a386979efb5e28961e46598ded9128b97}{station\_13},
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 13,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 13,
        14,
\}
\end{DoxyCode}
...
= \{
        ...
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 1,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 1,
        2,
\}
\end{DoxyCode}
...
= \{
        ...
        &\hyperlink{station__list__struct_8c_a975e612434ba9b8f7a0925465ca06e0c}{station\_2},
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 2,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 2,
        3,
\}
\end{DoxyCode}
...
= \{
        ...
        &\hyperlink{station__list__struct_8c_a1a2ee714f98b0926178ac3e23fcb67f1}{station\_3},
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 3,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 3,
        4,
\}
\end{DoxyCode}
...
= \{
        ...
        &\hyperlink{station__list__struct_8c_a0d01dece72c337dca8aaed89d5d90828}{station\_4},
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 4,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 4,
        5,
\}
\end{DoxyCode}
...
= \{
        ...
        &\hyperlink{station__list__struct_8c_a112b4f4a30a6cb400b22f7cd53d4ea97}{station\_5},
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 5,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 5,
        6,
\}
\end{DoxyCode}
...
= \{
        ...
        &\hyperlink{station__list__struct_8c_a83b82bde662361422111236c9d4518a6}{station\_6},
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 6,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 6,
        7,
\}
\end{DoxyCode}
...
= \{
        &\hyperlink{station__list__struct_8c_a66db907c5ec3efb7412b85acfc91031b}{station\_9},
        &\hyperlink{station__list__struct_8c_a2478f4bcac825a2937f6403ce17f26f2}{station\_7},
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 7,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 7,
        8,
\}
\end{DoxyCode}
...
= \{
        &\hyperlink{station__list__struct_8c_a86b4c5a19f2eaf61a7d85e962d0de862}{station\_10},
        &\hyperlink{station__list__struct_8c_aa12e857edaba93b4f1f6499550788485}{station\_8},
        (uint16\_t *) \hyperlink{radio__configuration_8h_a079cd45a1bbfedfbb94ebd6560eaf902}{RADIO\_STATION\_FREQ\_STORE\_ADR} + 8,
        (\textcolor{keywordtype}{char} *) \hyperlink{radio__configuration_8h_ab4103f5bd07b36785d220fe005dc65e3}{RADIO\_STATION\_NAME\_STORE\_ADR} + 
      \hyperlink{radio__configuration_8h_aed5209d4f73a4a25770bde0149625689}{RADIO\_STATION\_NAME\_STORE\_SIZE} * 8,
        9,
\}
\end{DoxyCode}
